...
def create_dash_layout(app,
                ...
                html.Div([
                    ...
                    dcc.Dropdown(options_in["purpose"],            #Purpose
                                 ...
                                 style ={'backgroundColor': colours["dropdownbox"],
                                         'font-size': fontsize["dropdown"]}),
                    html.Div([
                         html.Button('Update Time', id='time-update-btn', n_clicks=0, className="dash-bootstrap"),
                         html.Button('Clear 3D Orbits', id='clear-orbits-btn', n_clicks=0,
                                    style = {"display": "inline-block","float": "right"}, className="dash-bootstrap")],
    ...
    #                                 filter_action="native"#,
                ...
                ], style={"width": "70%", "float": "right", "display": "inline-block"}, className="dash-bootstrap"
                )
        ...
        # Slider filter
          html.Div([
            ...
            style={"width": "95%", "display": "inline-block"}, className="dash-bootstrap"
          )
