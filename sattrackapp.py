...
def update_graph(status, orbit, satname, satcatid,
    ...
    print("test1",status, orbit, satname, satcatid,
                 owner, launchvehicle,
                 purpose, year,df.shape[0])    
    ...
    for col,vals in input_filter_update.items():
        if col == "Purpose":
            ...
            print(col,sum(dff[col].isin(vals)))
    ...
    print("test2",status, orbit, satname, satcatid,
                 owner, launchvehicle,
                 purpose, year,dff.shape[0])
